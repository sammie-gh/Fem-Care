...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView);
            spaceItemIconSize = typedArray.getDimensionPixelSize(com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView_space_item_icon_size, resources.getDimensionPixelSize(com.irfaan008.irbottomnavigation.R.dimen.space_item_icon_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(com.irfaan008.irbottomnavigation.R.dimen.space_item_icon_only_size));
            spaceItemTextSize = typedArray.getDimensionPixelSize(com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView_space_item_text_size, resources.getDimensionPixelSize(com.irfaan008.irbottomnavigation.R.dimen.space_item_text_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(com.irfaan008.irbottomnavigation.R.dimen.space_item_icon_only_size));
            spaceBackgroundColor = typedArray.getColor(com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView_space_background_color, resources.getColor(com.irfaan008.irbottomnavigation.R.color.space_default_color));
            centreButtonColor = typedArray.getColor(com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView_centre_button_color, resources.getColor(com.irfaan008.irbottomnavigation.R.color.centre_button_color));
            activeSpaceItemColor = typedArray.getColor(com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView_active_item_color, resources.getColor(com.irfaan008.irbottomnavigation.R.color.space_white));
            inActiveSpaceItemColor = typedArray.getColor(com.irfaan008.irbottomnavigation.R.styleable.SpaceNavigationView_inactive_item_color, resources.getColor(com.irfaan008.irbottomnavigation.R.color.default_inactive_item_color));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (spaceBackgroundColor == NOT_DEFINED)
            spaceBackgroundColor = ContextCompat.getColor(context, com.irfaan008.irbottomnavigation.R.color.space_default_color);

        if (centreButtonColor == NOT_DEFINED)
            centreButtonColor = ContextCompat.getColor(context, com.irfaan008.irbottomnavigation.R.color.centre_button_color);

        if (centreButtonIcon == NOT_DEFINED)
            centreButtonIcon = R.drawable.near_me;

        if (activeSpaceItemColor == NOT_DEFINED)
            activeSpaceItemColor = ContextCompat.getColor(context, com.irfaan008.irbottomnavigation.R.color.space_white);

        if (inActiveSpaceItemColor == NOT_DEFINED)
            inActiveSpaceItemColor = ContextCompat.getColor(context, com.irfaan008.irbottomnavigation.R.color.default_inactive_item_color);

        if (spaceItemTextSize == NOT_DEFINED)
            spaceItemTextSize = (int) getResources().getDimension(com.irfaan008.irbottomnavigation.R.dimen.space_item_text_default_size);

        if (spaceItemIconSize == NOT_DEFINED)
            spaceItemIconSize = (int) getResources().getDimension(com.irfaan008.irbottomnavigation.R.dimen.space_item_icon_default_size);

        if (spaceItemIconOnlySize == NOT_DEFINED)
            spaceItemIconOnlySize = (int) getResources().getDimension(com.irfaan008.irbottomnavigation.R.dimen.space_item_icon_only_size);

        if (centreButtonRippleColor == NOT_DEFINED)
            centreButtonRippleColor = ContextCompat.getColor(context, com.irfaan008.irbottomnavigation.R.color.colorBackgroundHighlightWhite);
